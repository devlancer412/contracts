...
export interface RoosterInterface extends utils.Interface {
  functions: {
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address[],uint256[])": FunctionFragment;
    "baseStats(uint256)": FunctionFragment;
    ...
    "setBaseStats(uint256,uint16[])": FunctionFragment;
...
export interface Rooster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoosterInterface;
